    ...
    do
    {
        ...
        if (x == 1)
        {
            if (flag == 0)
            {
                ...
                cin >> total;
                cout << "Enter the details of the student with ID: " << total / 2 << endl;
                cout << "Name: ";
                cin >> name;
                cout << "Marks: ";
                cin >> marks;
            ...
            else
            {
                ...
                {
                    cout << "\nThe total strength of the class as entred above is " << total << endl;
                    cout << "But " << id << " exceeds that." << endl;
                    cout << "Do you want to increase the total to " << id << "\n1-->Yes, 2-->No,  Choose: ";
                    cin >> y;
                    if (y == 1)
                    {
                        total = id;
                        if (total == id)
                        {
                            cout << "\nChanges done,new total = " << total << endl;
                            cout << "Enter name: ";
                            cin >> name;
                            cout << "Enter marks: ";
                            cin >> marks;
